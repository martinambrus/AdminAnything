 ...
 */
public class AARemoveDisabledCommandEvent extends Event {

    /**
     * Name of the command to re-enable.
     */
     ...
     *
     * @param commandName Name of the command to re-enable.
     */
    public AARemoveDisabledCommandEvent(final String commandName) {
     ...
     *
     * @return Returns name of the command to re-enable.
     */
