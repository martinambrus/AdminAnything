 ...
 */
public class AARemoveCommandRedirectEvent extends Event {

    /**
     * The command line for which we want the redirect
     * to be removed.
     */
     ...
     *
     * @param commandLine The command line for which we want the redirect
     *                    to be removed.
     */
    public AARemoveCommandRedirectEvent(final String commandLine) {
     ...
     *
     * @return Returns the command line for which we want the redirect
     *         to be removed.
     */
