...
public class AASymbolicCommand extends Command implements PluginIdentifiableCommand {

    private final Plugin owningPlugin;
    private CommandExecutor executor;
    private TabCompleter completer;

    public AASymbolicCommand(String name, Plugin owner, String description, String permission) {
