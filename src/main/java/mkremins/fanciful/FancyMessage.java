...
import mkremins.fanciful.reflections.*;
...
public class FancyMessage
     ...
     * @throws IOException
     */
    public static FancyMessage deserialize(final String json) throws IOException {
            ...
            for (final Map.Entry<String, JsonElement> entry : messagePart.entrySet()) {
                ...
                if (TextualComponent.isTextKey(entry.getKey())) {
                    ...
                    if (entry.getValue().isJsonPrimitive()) {
                        ...
                        for (final Map.Entry<String, JsonElement> compositeNestedElement : entry.getValue()
